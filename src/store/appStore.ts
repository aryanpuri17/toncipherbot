...
const _defaultTasks: Task[] = [
  ...
  { id: '6', type: 'special', title: '📢 Community Share', description: 'Share TonCipher in a Telegram group with 100+ members. Submit a screenshot or link as proof — the team will validate within 24h.', reward: 0.80, rewardType: 'main', isActive: true, totalCompletions: 0, createdAt: new Date(Date.now() - 1 * 86400000).toISOString(), verificationMethod: 'manual', priority: 9, isPromoTask: true, icon: '📢', createdByUserId: 'platform', cooldownHours: 24 },
