...
const TikTokLogo: React.FC<{ size?: number }> = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Cyan offset shadow */}
    <path fill="#25F4EE" d="M61 17c1 9 7 14 18 15v10c-5 0-10-1-15-5v27c0 13-10 23-23 23S19 77 19 64s10-23 23-23c2 0 4 .3 6 .8V53c-2-.4-4-.6-6-.6-8 0-13 6-13 13s5 13 13 13 13-5 13-13V17h6z"/>
    {/* Red main shape — dominant color */}
    <path fill="#FE2C55" d="M64 20c1 9 7 14 18 15v10c-5 0-10-1-15-5v27c0 13-10 23-23 23S22 80 22 67s10-23 23-23c2 0 4 .3 6 .8V56c-2-.4-4-.6-6-.6-8 0-13 6-13 13s5 13 13 13 13-5 13-13V20h6z"/>
  </svg>
);
