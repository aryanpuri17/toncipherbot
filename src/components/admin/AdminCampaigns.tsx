      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-amber-500/20 text-amber-400 border border-amber-500/30">DEMO</span>
          </div>
          <p className="text-slate-400 text-sm mt-1">Advertiser system — demo data, not connected to the server</p>
        </div>
          ...
          <div key={campaign.id} className="glass-card p-5">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-400 mb-3">By {campaign.advertiserName}</p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500">Reward/action</p>
