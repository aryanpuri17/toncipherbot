...
const _defaultTasks: Task[] = [
  ...
  { id: '7', type: 'watch_video', title: 'Regarder notre vidéo YouTube', description: 'Regardez la vidéo pendant au moins 20 secondes pour valider', reward: 0.0300, rewardType: 'main', targetUrl: 'https://www.youtube.com/@telegram', isActive: true, totalCompletions: 0, maxCompletions: 500, createdAt: new Date(Date.now() - 4 * 86400000).toISOString(), verificationMethod: 'auto', priority: 6, icon: '▶️', createdByUserId: 'platform' },
  { id: '8', type: 'social', title: 'Nous suivre sur X (Twitter)', description: 'Suivez notre compte officiel sur X et restez informé des dernières news', reward: 0.0200, rewardType: 'main', targetUrl: 'https://x.com/telegram', isActive: true, totalCompletions: 0, maxCompletions: 800, createdAt: new Date(Date.now() - 3 * 86400000).toISOString(), verificationMethod: 'auto', priority: 4, icon: '🐦', createdByUserId: 'platform' },
  { id: '9', type: 'social', title: 'Nous suivre sur Instagram', description: 'Suivez notre compte Instagram pour voir nos dernières publications', reward: 0.0200, rewardType: 'main', targetUrl: 'https://www.instagram.com/telegram', isActive: true, totalCompletions: 0, maxCompletions: 800, createdAt: new Date(Date.now() - 3 * 86400000).toISOString(), verificationMethod: 'auto', priority: 3, icon: '📸', createdByUserId: 'platform' },
  { id: '10', type: 'social', title: 'Nous suivre sur TikTok', description: 'Abonnez-vous à notre TikTok et regardez nos vidéos exclusives', reward: 0.0200, rewardType: 'main', targetUrl: 'https://www.tiktok.com/@telegram', isActive: true, totalCompletions: 0, maxCompletions: 800, createdAt: new Date(Date.now() - 2 * 86400000).toISOString(), verificationMethod: 'auto', priority: 2, icon: '🎵', createdByUserId: 'platform' },
];
