...
const mockShopItems: ShopItem[] = [
  ...
  // ── Packs Créateur ─ marge 23-30% ──────────────────────────────────────────
  { id: '3',  name: 'Pack Starter',   description: 'Créditez 0.50 TON sur votre budget campagne — traitement standard',                    price: 0.50,  currency: 'main', type: 'task_credit', value: 0.50,  isActive: true, purchases: 0, icon: '📦', category: 'packs' },
  { id: '4',  name: 'Pack Basic',     description: 'Créditez 1.50 TON sur votre budget campagne — traitement standard',                    price: 1.50,  currency: 'main', type: 'task_credit', value: 1.50,  isActive: true, purchases: 0, icon: '📦', category: 'packs' },
  { id: '5',  name: 'Pack Standard',  description: 'Obtenez 3.15 TON de crédits campagne (+5% offerts) — traitement prioritaire',          price: 3.00,  currency: 'main', type: 'task_credit', value: 3.15,  isActive: true, purchases: 0, icon: '📦', category: 'packs' },
  { id: '6',  name: 'Pack Pro',       description: 'Obtenez 5.25 TON de crédits campagne (+5% offerts) — traitement prioritaire',          price: 5.00,  currency: 'main', type: 'task_credit', value: 5.25,  isActive: true, purchases: 0, icon: '💼', category: 'packs' },
  { id: '7',  name: 'Pack Business',  description: 'Obtenez 10.70 TON de crédits campagne (+7% offerts) — approbation rapide garantie',   price: 10.00, currency: 'main', type: 'task_credit', value: 10.70, isActive: true, purchases: 0, icon: '💼', category: 'packs' },
  { id: '8',  name: 'Pack Premium',   description: 'Obtenez 27 TON de crédits campagne (+8% offerts) — support dédié',                    price: 25.00, currency: 'main', type: 'task_credit', value: 27.00, isActive: true, purchases: 0, icon: '👑', category: 'packs' },
  { id: '9',  name: 'Pack Elite',     description: 'Obtenez 54.50 TON de crédits campagne (+9% offerts) — accès VIP annonceur',            price: 50.00, currency: 'main', type: 'task_credit', value: 54.50, isActive: true, purchases: 0, icon: '👑', category: 'packs' },
  { id: '10', name: 'Pack Ultimate',  description: 'Obtenez 110 TON de crédits campagne (+10% offerts) — partenariat annonceur premium',   price: 100.00,currency: 'main', type: 'task_credit', value: 110.00,isActive: true, purchases: 0, icon: '💎', category: 'packs' },
  // ── Premium ─────────────────────────────────────────────────────────────────
